...
The autobox pragma allows methods to be called on ARRAY refs,
...
Methods are called on primitive values by using the L<arrow operator|perlop/"The Arrow Operator">. As with
